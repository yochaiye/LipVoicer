...
class AudioVisualModel(torch.nn.Module):
    ...
    def __init__(self, nets):
        ...
        # classifier guidance
        torch.manual_seed(0)  # ensure that the null conditioner can be reproduced
        # null conditioners
        ...
        # self.register_buffer("mouthroi_null", torch.zeros(1, 1, 1, 88, 88))  # lips regions frames are 88x88 each
        # self.register_buffer("face_null", torch.zeros(1, 3, 224, 224))  # face image size is 224x224
