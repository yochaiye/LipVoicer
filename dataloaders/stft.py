...
# def normalise_mel(melspec, max_val=9.3, min_val=math.log(1e-9)): 
#     melspec = (melspec - min_val)*2 / (max_val-min_val) - 1     #log(1e-9)~9.3 --> -1~1
#     return melspec

# def denormalise_mel(melspec, max_val=9.3, min_val=math.log(1e-9)): 
#     melspec = (melspec+1) * (max_val-min_val) / 2 + min_val
#     return melspec
